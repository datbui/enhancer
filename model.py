...
def srcnn(lr_images, pkeep_conv=1.0, devices=['/device:CPU:0']):
    filters_shape = [5, 1, 3, 3, 3, 3, 1, 9]
    filters = [56, 12, 12, 12, 12, 12, 56]
    channels = 1
    for d in devices:
        with tf.device(d):
