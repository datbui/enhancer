...
flags.DEFINE_string("subset", "kidney", "The name of subset [train, validation, test]")
flags.DEFINE_string("extension", "jpg", "The file extension [tif, jpg....]")
flags.DEFINE_string("checkpoint_dir", "kidney_checkpoint", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("summaries_dir", "kidney_summaries", "Directory name to save training summaries[summaries]")
flags.DEFINE_string("log_dir", "kidney_logs", "Directory name to store logs [logs]")
flags.DEFINE_string("output_dir", "kidney_outputs", "Directory name to store output images [outputs]")
